...
class SiteController extends Controller {
    ...
    public function actionHome() {
        ...
        $end = date('Y-m-d', strtotime($begin . ' +1 month')) . ' 60:60:60';
        $expected_datas = \common\models\Appointment::find()->where(['<=', 'eta', $end])->andWhere(['>=', 'eta', $begin])->orderBy(['eta' => SORT_ASC])->all();
