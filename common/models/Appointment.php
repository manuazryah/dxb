...
class Appointment extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['vessel_type', 'vessel', 'port_of_call', 'tug', 'barge', 'nominator', 'terminal', 'charterer', 'shipper', 'stage', 'sub_stages', 'status', 'CB', 'UB', 'estimate_status', 'currency','closeestimate_status'], 'integer'],
